...
export default function Header({ children }: PropsWithChildren) {
    ...
    const conversationId = pathname?.split("/dashboard/")?.[1];
    ...
    return (
        <div className="flex-1 flex flex-col w-full m-5">
            <div className="bg-muted rounded-t-lg p-4 flex justify-between items-center border-border dark:border-[#313D45]">
